...
ulList.querySelectorAll("li")[0].firstElementChild.className='hover';
for(var i=0,len=ulList.children.length;i<len;i++){
  ulList.children[i].onmouseover=function(){
        console.log(ulList.children.length)
        for(var j=0;j<ulList.querySelectorAll("li").length;j++){
            ulList.querySelectorAll("li")[j].firstElementChild.className='';
        }
        this.firstElementChild.className='hover';
  }
}
